...
def training_data(
    ...
    with registry.start_run(run_name='model-training-run', run_id=mlflow_run_id) as run:
        ...
        print('artifact_url: '. run.info.artifact_uri)
...
# python -m src.model_pipeline._08_training --train_path "datasets/data-pipeline" --preprocessor_path "artifacts" --best_params_path "artifacts" --mlflow_run_id "301cdd1adb6d4213bd01061133422714"